...
export namespace modalContentMethods {
    ...
    export function rules () {
        return html`
            ...
            <p class="modal-paragraph" style="background-color:#f1f1f1">Each crew has a special ability that can be applied to any crew's die to meet the missions requirements.</p>
            ...
            <p class="modal-paragraph" style="background-color:#f1f1f1">After each mission attempt crews triggers will be revealed if they worked with another crew member who had those traits. When a crew memeber has all 3 of their triggers revealed they go space mad, murder everone on the ship, and you lose the game. Only one trigger can be revealed per crew member each round.</p>
            ...
            <p class="modal-paragraph" style="background-color:#f1f1f1">When all missions are completed, the ship hasn't exploded, and none of the crew are space mad, you win the game.</p>
            ...
            <div class="modal-glossary-section">
            <img style="width:300px;float:right;margin-left:5px" src="./images/modal-content/glossary/mission-cards.jpg" alt="Space Madness title image">
            ...
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img style="width:300px;float:left;margin-right: 10px;" src="./images/modal-content/glossary/crew-card.jpg" alt="Space Madness title image">
            ...
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img style="width:353px;float:right;margin-left:5px" src="./images/modal-content/glossary/triggers.jpg" alt="Space Madness title image">
            ...
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img style="width:142px;float:left;margin-right: 10px;" src="./images/modal-content/glossary/crew-ability.jpg" alt="Space Madness title image">
            ...
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img style="width:357px;float:right;margin-left:5px" src="./images/modal-content/glossary/players-crew-triggers.jpg" alt="Space Madness title image">
            ...
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img style="width:144px;float:left;margin-right: 10px;" src="./images/modal-content/glossary/traits.jpg" alt="Space Madness title image">
