    ...
    export function rules (isSimpleGame:boolean) {
        if (isSimpleGame) {
            return html`
                ...
                <h3>Mission card:</h3><p class="modal-paragraph">These cards have a dice roll requirment that must be met. When you have successfully met the requirments of all nine mission cards you win the game.</p>
                </div>
                <div class="seperator"></div>
                <div class="modal-glossary-section">
        ...
        return html`
            ...
            <h3>Crew ability:</h3><p class="modal-paragraph">Each crew member has an ability that they can apply to a die roll to meet the mission requirment. Crew that have failed a mission will not have an ability until they have succeeded at another mission.</p>
            </div>
            <div class="seperator"></div>
            <div class="modal-glossary-section">
            <img class="modal-img-right" style="width:357px;" src="./images/modal-content/glossary/players-crew-triggers.jpg" alt="Space Madness title image">
